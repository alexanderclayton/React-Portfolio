import Image1 from '../assets/images/first-application.jpg';
import Image2 from '../assets/images/group-project-1.jpg';
import Image3 from '../assets/images/kanye-rest-image.jpg';
import Image4 from '../assets/images/languages-signpost.jpg';
import Image5 from '../assets/images/placeholder-image-4.jpg';
import Image6 from '../assets/images/collage-cat.jpg';


export const ProjectCards = [
    {
        name: "First Project: Horiseon Webpage",
        image: Image1,
        skills: "HTML, CSS",
        link: "https://alexanderclayton.github.io/Module-1-Challenge-Horiseon/",
        alt: "Hands Holding a lightbulb",
        description: "This was the very first weekly challenge we were given in the KU Coding Bootcamp.  Our challenge was to refactor some buggy code. This is the end result, free of any bugs :)",
        github: "https://github.com/alexclaytonbootcamp/Module-1-Challenge-Horiseon"
    },
    {
